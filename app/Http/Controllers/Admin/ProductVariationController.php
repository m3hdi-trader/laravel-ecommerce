    ...
    public function update($variationIds)
    {
        foreach ($variationIds as $key => $value) {
            ...
            $productVariation->update([
                ...
                'date_on_sale_from' => DateConversion::ConvertSolarDateToGregorian($value['date_on_sale_from']),
                'date_on_sale_to' => DateConversion::ConvertSolarDateToGregorian($value['date_on_sale_to']),
            ]);
        }
    }
