        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3 mb-5">
                    <div class="card">
                        <img class="card-img-top" src="{{ url(env('PRODUCT_IMAGES_UPLOAD_PAHT') . $product->primary_image) }}"
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <form action="{{ route('admin.product.image.destroy', ['product' => $product->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <form action="{{ route('admin.product.image.set_primary', ['product' => $product->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden"name="image_id" value="{{ $image->id }}">
