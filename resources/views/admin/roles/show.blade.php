        ...
        <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control" type="text" disabled name="display_name" value="{{ $role->display_name }}">
                </div>

                <div class="form-group col-md-3">
                    <label for="name">نام</label>
                    <input class="form-control" type="text" disabled name="name" value="{{ $role->name }}">
                </div>
